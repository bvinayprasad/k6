...
//fmt.Println("into default req signer")
...
//fmt.Println("inside http signer sign method")
	if signer.ShouldHashBody(request) {
		//fmt.Println("----------------------------------")
		//fmt.Println("inside should hash signer sign method")
	...
	fmt.Println("##### SIGNATURE: ",authValue)
